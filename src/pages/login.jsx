                        ...
                        <div className="rounded-xl bg-white shadow-xl">
                            <div className="p-6 sm:p-16">
                                <div className="space-y-4">
                                    <img src='../../public/logo.png' loading="lazy" className="w-10" />
                                        <h2 className="mb-8 text-2xl text-cyan-900 font-bold">Sign in to unlock the <br /> Easy to Sell.</h2>
                                </div>
                                <div className="mt-16 grid space-y-4">
                                    <button className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100" onClick={loginWithGG}>
